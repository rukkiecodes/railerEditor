                  ...
                  <tbody style="box-sizing: border-box;">
                    <tr style="box-sizing: border-box;">
                      ...
                      <td class="cell c1776" style="box-sizing: border-box; width: 70%; vertical-align: middle;" width="70%" valign="middle">
                        <div class="c1144" style="box-sizing: border-box; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px; font-size: 17px; font-weight: 300;">Railer Newsletter Builder
                          ...
                          <tbody style="box-sizing: border-box;">
                            <tr style="box-sizing: border-box;">
                              <td class="card-content" style="box-sizing: border-box; font-size: 13px; line-height: 20px; color: rgb(111, 119, 125); padding-top: 10px; padding-right: 20px; padding-bottom: 0px; padding-left: 20px; vertical-align: top;" valign="top">
                                ...
                                <p class="card-text" style="box-sizing: border-box;">Import, build, test and export responsive newsletter templates faster than ever using the Railer Newsletter Builder.
                                </p>
                    ...
                    <tr style="box-sizing: border-box;">
                      <td class="footer-cell" style="box-sizing: border-box;">
                        <div class="c2577" style="box-sizing: border-box; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;">
                          <p class="footer-info" style="box-sizing: border-box;">Railer Newsletter Builder is a free and open source preset (plugin) used on top of the Railer core library.
                            For more information about and how to integrate it inside your applications check
                          </p>
                          <p style="box-sizing: border-box;">
                            <a href="https://github.com/artf/Railer-preset-newsletter" class="link" style="box-sizing: border-box; color: rgb(217, 131, 166);">Railer Newsletter Preset</a>
                            <br style="box-sizing: border-box;">
                          </p>
                        </div>
